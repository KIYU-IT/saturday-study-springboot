...
public class SandwichDirector {
    ...
    public SandwichDTO buildSpicyItalian(SandwichBuilder builder) {
        return builder
    ...
    public SandwichDTO buildChickenBaconAvocado(SandwichBuilder builder) {
        return builder
    ...
    public SandwichDTO buildPulledPorkBBQ(SandwichBuilder builder) {
        return builder
    ...
    // 🍤 **쉬림프 샌드위치** (새우 + 다양한 야채)
    public SandwichDTO buildShrimp(SandwichBuilder builder) {
        return builder
                .selectBread("WHITE")
